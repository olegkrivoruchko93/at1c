...
Процедура иб_РезультатОбработкаРасшифровки(Элемент, Расшифровка, СтандартнаяОбработка)
	...
	ИначеЕсли ТипЗнч(Расшифровка) = Тип("Строка") Тогда
		...
		Если Идентификатор = "ОтрицательныеОстаткиНаСчетахБУ" Тогда
			ОткрытьВедомостьПоСчетуССубсчетами(Расшифровка);
...
&НаКлиенте
Процедура ОткрытьВедомостьПоСчетуССубсчетами(Расшифровка)
