...
Процедура ИнициализироватьСписокОбластейПоискаДублей()
	...
	Для Каждого СтрокаТаблицы Из ТаблицаНастроек Цикл
		...
		Если СтрокаТаблицы.ПолноеИмя = "Справочник.Контрагенты" ИЛИ СтрокаТаблицы.ПолноеИмя = "Справочник.ДоговорыКонтрагентов"
		 ИЛИ СтрокаТаблицы.ПолноеИмя = "Справочник.Номенклатура" Тогда
